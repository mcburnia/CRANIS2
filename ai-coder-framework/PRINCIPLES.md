...
The developer directs. The AI executes under supervision.
...
AI is used where it adds measurable value. It is not used as a substitute for professional competence.

Appropriate uses include:

- Drafting code, documentation, and compliance content
- Analysing codebases, dependencies, and security findings
- Researching technical approaches and regulatory requirements
- Automating repetitive implementation tasks
- Generating test scaffolding and data
...
AI involvement in any deliverable is recorded as a matter of course.
...
Every session is captured. Every decision is traceable.

This principle eliminates the retrospective scramble to reconstruct what was done and why. Session capture runs automatically. Project files (CLAUDE.md, RESTART.md, BACKLOG.md) are maintained as living documents. Commit messages explain intent, not just mechanics.

Evidence is a byproduct of disciplined work, not an additional burden. The systems and habits described in the accompanying Standards and Guidelines documents make evidence collection automatic and unobtrusive.
...
Speed without quality is rework. Rework is the most expensive form of development.
