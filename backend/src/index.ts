...
import technicalFileRoutes from './routes/technical-file/index.js';
...
import { nonprofitUserRouter } from "./routes/nonprofit-verification.js";
...
const BILLING_EXEMPT_PATHS = ['/api/auth', '/api/billing', '/api/bonus-code', '/api/affiliate', '/api/admin', '/api/health', '/api/github/webhook', '/api/repo/webhook', '/api/docs', '/api/v1', '/api/conformity-assessment', '/api/notified-bodies', '/api/market-surveillance-authorities', '/api/account'];
...
app.use('/api/products', seeEstimatorRoutes);
