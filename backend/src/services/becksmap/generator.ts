// @ts-nocheck
// Vendored from tools/becksmap/lib/generator.js — renderer for the roadmap pages.
// Source of truth: tools/becksmap/lib. Re-vendor (copy + prepend this header) on change.
/*
