...
export interface CertificateResult {
  ...
  /** ML-DSA-65 signature (or null if PQC key not configured) */
...
key pair(s). Signatures can be verified using the public keys published at
\`/.well-known/cranis2-signing-key.pem\` (Ed25519) and
\`/.well-known/cranis2-signing-key-mldsa.pem\` (ML-DSA-65, post-quantum).*
