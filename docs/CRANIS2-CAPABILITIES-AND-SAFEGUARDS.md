...
**Trust Centre Contact Rate Limiting:**
...
- Prevents spam and harassment through the Trust Centre
...
| Email | Resend | Transactional emails (billing, notifications, Trust Centre contact) |
