...
const SECTIONS = [
  {
    ...
    description: 'These questions help determine your product\'s CRA risk category. The Cyber Resilience Act classifies products with digital elements into four categories: Default, Important Class I, Important Class II, and Critical. Each has different compliance requirements.',
  },
  {
    id: 'vulnerability',
...
const QUESTIONS = [
  ...
  },
  {
    ...
    explanation: 'Article 13(8) requires manufacturers to regularly test and review the security of their products. This includes monitoring public vulnerability databases (NVD, OSV, GitHub Advisories) for known vulnerabilities affecting your code and third-party components. Reactive-only approaches, such as waiting for someone to report a vulnerability, are insufficient under the CRA.',
